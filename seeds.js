...
const categories = [
	{
		...
		type: "mushroom",
		color: "var(--mushroom)",
		_id: "5ee77607640bc622b0e80e08",
	},
	{
		title: "Berries",
		type: "berry",
		color: "var(--berry)",
		_id: "5ee77607640bc622b0e80e09",
	},
	{
		title: "Flowers",
		type: "flower",
		color: "var(--flower)",
		_id: "5ee77607640bc622b0e80e0a",
	},
	{
		title: "Reductions",
		type: "reduction",
		color: "var(--reduction)",
		_id: "5ee77607640bc622b0e80e0b",
	},
	{
		title: "About Us",
		type: "about",
		color: "var(--primary)",
		_id: "5ee77607640bc622b0e80e0c",
	},
];
...
const deliveries = [
	{
		title: "Premium",
		price: 50,
		description: "Premium tracked delivery service",
		speed: 1,
	},
	{
		title: "Standard",
		price: 15,
		description: "Standard untracked delivery service",
		speed: 5,
	},
];
	...
	LandingSection.deleteMany({}, (err) => {
		if (err) {
			...
			addToLanding(
				...
				"mushroom",
				[
					{ title: "Shop Now", link: "/products/mushrooms" },
					{ title: "Shop Later", link: "/products/mushrooms" },
				]
			);
			addToLanding(
				true,
				...
				"berry",
				[
					{ title: "Shop Now", link: "/products/berries" },
					{ title: "Shop Later", link: "/products/berries" },
				]
			);
			addToLanding(
				false,
				...
				"flower",
				[
					{ title: "Shop Now", link: "/products/flowers" },
					{ title: "Shop Later", link: "/products/flowers" },
				]
			);
		}
	});
